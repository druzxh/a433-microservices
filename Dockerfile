# Stage base menggunakan Node.js versi 14 pada Alpine Linux sebagai base image
FROM node:14-alpine as base
# Mengatur direktori kerja di dalam container sebagai /src
WORKDIR /src
# Menyalin file package.json dan package-lock.json (jika ada) ke direktori /src di dalam container
COPY package*.json ./
...
COPY ./*.js ./
COPY ./.env ./
# Memaparkan port 3000 untuk komunikasi luar ke dalam container
EXPOSE 3000
